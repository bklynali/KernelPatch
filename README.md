...
If you are using Android, [BKPatch](https://github.com/bklynali/BKPatch) would be a better choice.
...
* [YPatch](https://github.com/Yervant7/YPatch): Core.
...
YPatch is licensed under the **GNU General Public License (GPL) 2.0** ([https://www.gnu.org/licenses/old-licenses/gpl-2.0.html](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html)).
